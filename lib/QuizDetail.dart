                ...
                return Container(
                  ...
                  child: ConstrainedBox(
                    constraints: BoxConstraints(
                      // Adjust factor to control how tall the purple area is at minimum
                        ...
                        children: [
                                    ...
                                    children: [
                                      ...
                                      TextSpan(
                                        ...
                                        recognizer: TapGestureRecognizer()
                                          ..onTap = () {
                                            // TODO: expand description or navigate
                                          },
                                      ),
                                    ],
                                  ),
                          ...
                          Wrap(
                            ...
                            children: selectedMods.map((modId) {
                              final mod =
                              QuizModsStore.getModById(modId);
                              if (mod == null) {
                          ...
                          SizedBox(
                            ...
                            child: ElevatedButton(
                              ...
                              style: ElevatedButton.styleFrom(
                                backgroundColor: const Color(0xFF6C2BDB),
                                padding: const EdgeInsets.symmetric(vertical: 18),
                                shape: RoundedRectangleBorder(
                                  borderRadius: BorderRadius.circular(16),
                                  side: const BorderSide(
                                    color: Colors.white24, // subtle outline
                                    width: 1.2,
                                  ),
                                ),
                                elevation: 6,
